...
final class Table {
  ObjectNode getCardsOnTable(ArrayList<ArrayList<GenericCard>> cardsOnTable,
  ...
  ObjectNode getCardAtPosition(final ObjectMapper objectMapper, final int x, final int y,
